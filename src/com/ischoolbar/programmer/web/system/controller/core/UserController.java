...
import com.ischoolbar.programmer.core.common.model.json.ComboBox;
...
import com.ischoolbar.programmer.tag.vo.datatable.DataTables;
...
public class UserController {
	...
	public void datagrid(TSUser user,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		com.ischoolbar.programmer.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, user);

package com.ischoolbar.programmer.tag.core.easyui;
...
import com.ischoolbar.programmer.core.util.ApplicationContextUtil;
...
import com.ischoolbar.programmer.tag.vo.easyui.ColumnValue;
import com.ischoolbar.programmer.tag.vo.easyui.DataGridColumn;
import com.ischoolbar.programmer.tag.vo.easyui.DataGridUrl;
import com.ischoolbar.programmer.tag.vo.easyui.OptTypeDirection;
...
public class DataGridTag extends TagSupport {
	...
	public String getNoAuthOperButton(){
		...
		com.ischoolbar.programmer.core.util.LogUtil.info("----getNoAuthOperButton-------"+sb.toString());
		return sb.toString(); 
	}
